...
$row = $db->get_movie(11); //Save the result of function get_movie of the DB class to the variable $row
...
<div class="container"> <!-- Div for page content -->
  <div class="content-container"> <!-- Container div for movie information -->
    <?php echo '<div class="movie-page-content" style="background: linear-gradient(to bottom, rgba(0,0,0,0), #151515), url('.$row['movieCover'].') no-repeat bottom center fixed; background-size: cover;">';
      echo '<img class="movie-logo" src="'.$row['movieLogo'].'" style="margin-top:280px;">'; ?>
      <p class="movie-desc" style="margin-top:30px;"><?php echo $row['movieDesc'];?></p>
      <br><br>
  ...
  <div class="form-container"> <!-- Container div of the booking form -->
    ...
    <div class="container-time"><img src="../images/cinema-seats.png" style="width: 90%; height:750px;"></div> <!-- Div containing image with movie locations -->
  </div>    
