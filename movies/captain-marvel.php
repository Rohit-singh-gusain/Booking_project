...
$row = $db->get_movie(5); //Save the result of function get_movie of the DB class to the variable $row
...
<div class="container"> <!-- Div for page content -->
  <div class="content-container"> <!-- Container div for movie information -->
    ...
    <br>
    <div class="trailer-container" style="margin-top:860px;"> <!-- Div for the movie trailer -->
  ...
  <div class="form-container" style="margin-top:100px;"> <!-- Container div of the booking form -->
