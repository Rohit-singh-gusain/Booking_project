...
$row = $db->get_movie(6); //Save the result of function get_movie of the DB class to the variable $row
...
<div class="container"> <!-- Div for page content -->
  <div class="content-container"> <!-- Container div for movie information -->
    ...
    <br>
    <div class="trailer-container" style="margin-top:880px;"> <!-- Div for the movie trailer  -->
  ...
  <div class="form-container" style="margin-top:120px;"> <!-- Container div of the booking form -->
