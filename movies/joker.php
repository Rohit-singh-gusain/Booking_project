...
$row = $db->get_movie(6); //Αποθήκευση του αποτελέσματος της function get_movie της κλάσης Db στη μεταβλητή $row
...
<div class="container"> <!-- Div για το περιεχόμενο της σελίδας -->
  <div class="content-container"> <!-- Container div για τις πληροφορίες της ταινίας -->
    <?php echo '<div class="movie-page-content" style="background: linear-gradient(to bottom, rgba(0,0,0,0), #151515), url('.$row['movieCover'].') no-repeat center center fixed; background-size: cover;">';
      echo '<img class="movie-logo" src="'.$row['movieLogo'].'" style="margin-top:250px;">'; ?>
    ...
    <br>
    <div class="trailer-container" style="margin-top:880px;"> <!-- Div για το trailer της ταινίας -->
  ...
  <div class="form-container" style="margin-top:120px;"> <!-- Container div της φόρμας κρατήσεων -->
