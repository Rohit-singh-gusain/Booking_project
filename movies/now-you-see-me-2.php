...
$row = $db->get_movie(7); //Save the result of function get_movie of the DB class to the variable $row
...
<div class="container"> <!-- Div for page content -->
  <div class="content-container"> <!-- CContainer div for movie information -->
      ...
      echo '<img class="movie-logo" src="'.$row['movieLogo'].'" style="margin-top:330px;">'; ?>
