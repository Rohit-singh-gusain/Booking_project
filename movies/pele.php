...
$row = $db->get_movie(10); //Αποθήκευση του αποτελέσματος της function get_movie της κλάσης Db στη μεταβλητή $row
...
<div class="container"> <!-- Div για το περιεχόμενο της σελίδας -->
  <div class="content-container"> <!-- Container div για τις πληροφορίες της ταινίας -->
    <?php echo '<div class="movie-page-content" style="background: linear-gradient(to bottom, rgba(0,0,0,0), #151515), url('.$row['movieCover'].') no-repeat bottom center fixed; background-size: cover;">';
      echo '<img class="movie-logo" src="'.$row['movieLogo'].'" style="margin-top:180px;">'; ?>
      <p class="movie-desc" style="margin-top:-15px;"><?php echo $row['movieDesc'];?></p>
      <br><br>
