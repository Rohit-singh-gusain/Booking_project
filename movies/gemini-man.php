...
$row = $db->get_movie(4); //Save the result of function get_movie of the DB class to the variable $row
...
<div class="container"> <!-- Div for page content -->
    <div class="content-container"> <!-- Container div for movie information -->
      <?php echo '<div class="movie-page-content" style="background: linear-gradient(to bottom, rgba(0,0,0,0), #151515), url('.$row['movieCover'].') no-repeat center center fixed; background-size: cover;">'; 
        echo '<img class="movie-logo" src="'.$row['movieLogo'].'" style="margin-top:300px;">'; ?>
        <p class="movie-desc" style="margin-top:10px;"><?php echo $row['movieDesc'];?></p>
        <br><br>
    ...
    <br>
    <div class="trailer-container"> <!-- Div for the movie traile -->
