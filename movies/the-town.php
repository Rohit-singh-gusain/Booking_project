...
$row = $db->get_movie(12); //Save the result of function get_movie of the DB class to the variable $row
...
<div class="container"> <!-- Div for page content -->
  <div class="content-container"> <!-- Container div for movie information -->
    ...
    echo '<img class="movie-logo" src="'.$row['movieLogo'].'" style="margin-top:290px;">'; ?>
    <p class="movie-desc" style="margin-top:-5px;"><?php echo $row['movieDesc'];?></p>
    <br><br>
